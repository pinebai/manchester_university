!----------------------------------------------------------!
!     3D DROPLET-SIZE MOMENTS MODEL
!----------------------------------------------------------!
!     DOMINIC P. JONES  09.11.2006
!----------------------------------------------------------!
!     CONTAINING:
!     STANDARD AND MODIFIED DRAG MODELS,
!     BREAK-UP AND COLLISION MODELS.
!
!     EMPLOYING:
!     FULLY COLLOCATED VELOCITY SCHEME,
!     LAGUERRE DISTRIBUTION CLOSURE.
!
!     SETUP: 
!     BLOCKDATA.F95, PROPERTIES.F95, COMMON.INC.
!     REQUIRES TECPLOT TO VIEW OUTPUT FILES.
!----------------------------------------------------------!
!
      program main
